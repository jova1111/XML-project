...
public class DateUtil {
    ...
    public static boolean isBeforeOrSameDay(Date date1, Date date2) {
        ...
        Date dayAfterDate2 = calendar.getTime();
        return isBeforeDay(date1, dayAfterDate2);
    }

    public static boolean isAfterOrSameDay(Date date1, Date date2) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date2);
        calendar.add(Calendar.DATE, -1);
        Date dayBeforeDate2 = calendar.getTime();
        return isAfterDay(date1, dayBeforeDate2);
    }
